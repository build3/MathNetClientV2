...
!(function (a, b) {
    ...
    }); function J(a, b) { while ((a = a[b]) && a.nodeType !== 1);return a; }r.each({
    ...
    }, (a, b) => { r.fn[a] = function (c, d) { let e = r.map(this, b, c); return a.slice(-5) !== 'Until' && (d = c), d && typeof d === 'string' && (e = r.filter(d, e)), this.length > 1 && (I[a] || r.uniqueSort(e), H.test(a) && e.reverse()), this.pushStack(e); }; }); const K = /[^\x20\t\r\n\f]+/g; function L(a) { const b = {}; return r.each(a.match(K) || [], (a, c) => { b[c] = !0; }), b; }r.Callbacks = function (a) {
        a = typeof a === 'string' ? L(a) : r.extend({}, a); let b; let c; let d; let e; let f = []; let g = []; let h = -1; const i = function () { for (e = a.once, d = b = !0; g.length; h = -1) { c = g.shift(); while (++h < f.length)f[h].apply(c[0], c[1]) === !1 && a.stopOnFalse && (h = f.length, c = !1); }a.memory || (c = !1), b = !1, e && (f = c ? [] : ''); }; var j = {
    ...
    }; function M(a) { return a; } function N(a) { throw a; } function O(a, b, c) { let d; try { a && r.isFunction(d = a.promise) ? d.call(a).done(b).fail(c) : a && r.isFunction(d = a.then) ? d.call(a, b, c) : b.call(void 0, a); } catch (a) { c.call(void 0, a); } }r.extend({
        Deferred(b) {
    ...
    }); const P = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/; r.Deferred.exceptionHook = function (b, c) { a.console && a.console.warn && b && P.test(b.name) && a.console.warn(`jQuery.Deferred exception: ${b.message}`, b.stack, c); }, r.readyException = function (b) { a.setTimeout(() => { throw b; }); }; const Q = r.Deferred(); r.fn.ready = function (a) { return Q.then(a).catch((a) => { r.readyException(a); }), this; }, r.extend({
        isReady: !1, readyWait: 1, holdReady(a) { a ? r.readyWait++ : r.ready(!0); }, ready(a) { (a === !0 ? --r.readyWait : r.isReady) || (r.isReady = !0, a !== !0 && --r.readyWait > 0 || Q.resolveWith(d, [r])); },
    }), r.ready.then = Q.then; function R() {
        d.removeEventListener('DOMContentLoaded', R),
        a.removeEventListener('load', R), r.ready();
    }d.readyState === 'complete' || d.readyState !== 'loading' && !d.documentElement.doScroll ? a.setTimeout(r.ready) : (d.addEventListener('DOMContentLoaded', R), a.addEventListener('load', R)); var S = function (a, b, c, d, e, f, g) { let h = 0; const i = a.length; let j = c == null; if (r.type(c) === 'object') { e = !0; for (h in c)S(a, b, h, c[h], !0, f, g); } else if (void 0 !== d && (e = !0, r.isFunction(d) || (g = !0), j && (g ? (b.call(a, d), b = null) : (j = b, b = function (a, b, c) { return j.call(r(a), c); })), b)) for (;h < i; h++)b(a[h], c, g ? d : d.call(a[h], h, b(a[h], c))); return e ? a : j ? b.call(a) : i ? b(a[0], c) : f; }; const T = function (a) { return a.nodeType === 1 || a.nodeType === 9 || !+a.nodeType; }; function U() { this.expando = r.expando + U.uid++; }U.uid = 1, U.prototype = {
        cache(a) { let b = a[this.expando]; return b || (b = {}, T(a) && (a.nodeType ? a[this.expando] = b : Object.defineProperty(a, this.expando, { value: b, configurable: !0 }))), b; }, set(a, b, c) { let d; const e = this.cache(a); if (typeof b === 'string')e[r.camelCase(b)] = c; else for (d in b)e[r.camelCase(d)] = b[d]; return e; }, get(a, b) { return void 0 === b ? this.cache(a) : a[this.expando] && a[this.expando][r.camelCase(b)]; }, access(a, b, c) { return void 0 === b || b && typeof b === 'string' && void 0 === c ? this.get(a, b) : (this.set(a, b, c), void 0 !== c ? c : b); }, remove(a, b) { let c; const d = a[this.expando]; if (void 0 !== d) { if (void 0 !== b) { r.isArray(b) ? b = b.map(r.camelCase) : (b = r.camelCase(b), b = b in d ? [b] : b.match(K) || []), c = b.length; while (c--) delete d[b[c]]; }(void 0 === b || r.isEmptyObject(d)) && (a.nodeType ? a[this.expando] = void 0 : delete a[this.expando]); } }, hasData(a) { const b = a[this.expando]; return void 0 !== b && !r.isEmptyObject(b); },
    }; const V = new U();
    const W = new U(); const X = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/; const
        Y = /[A-Z]/g; function Z(a) { return a === 'true' || a !== 'false' && (a === 'null' ? null : a === `${+a}` ? +a : X.test(a) ? JSON.parse(a) : a); } function $(a, b, c) { let d; if (void 0 === c && a.nodeType === 1) if (d = `data-${b.replace(Y, '-$&').toLowerCase()}`, c = a.getAttribute(d), typeof c === 'string') { try { c = Z(c); } catch (e) {}W.set(a, b, c); } else c = void 0; return c; }r.extend({
        hasData(a) { return W.hasData(a) || V.hasData(a); }, data(a, b, c) { return W.access(a, b, c); }, removeData(a, b) { W.remove(a, b); }, _data(a, b, c) { return V.access(a, b, c); }, _removeData(a, b) { V.remove(a, b); },
    }), r.fn.extend({ data(a, b) { let c; let d; let e; const f = this[0]; const g = f && f.attributes; if (void 0 === a) { if (this.length && (e = W.get(f), f.nodeType === 1 && !V.get(f, 'hasDataAttrs'))) { c = g.length; while (c--)g[c] && (d = g[c].name, d.indexOf('data-') === 0 && (d = r.camelCase(d.slice(5)), $(f, d, e[d]))); V.set(f, 'hasDataAttrs', !0); } return e; } return typeof a === 'object' ? this.each(function () { W.set(this, a); }) : S(this, function (b) { let c; if (f && void 0 === b) { if (c = W.get(f, a), void 0 !== c) return c; if (c = $(f, a), void 0 !== c) return c; } else this.each(function () { W.set(this, a, b); }); }, null, b, arguments.length > 1, null, !0); }, removeData(a) { return this.each(function () { W.remove(this, a); }); } }), r.extend({ queue(a, b, c) { let d; if (a) return b = `${b || 'fx'}queue`, d = V.get(a, b), c && (!d || r.isArray(c) ? d = V.access(a, b, r.makeArray(c)) : d.push(c)), d || []; }, dequeue(a, b) { b = b || 'fx'; const c = r.queue(a, b); let d = c.length; let e = c.shift(); const f = r._queueHooks(a, b); const g = function () { r.dequeue(a, b); }; e === 'inprogress' && (e = c.shift(), d--), e && (b === 'fx' && c.unshift('inprogress'), delete f.stop, e.call(a, g, f)), !d && f && f.empty.fire(); }, _queueHooks(a, b) { const c = `${b}queueHooks`; return V.get(a, c) || V.access(a, c, { empty: r.Callbacks('once memory').add(() => { V.remove(a, [`${b}queue`, c]); }) }); } }), r.fn.extend({
        queue(a, b) { let c = 2; return typeof a !== 'string' && (b = a, a = 'fx', c--), arguments.length < c ? r.queue(this[0], a) : void 0 === b ? this : this.each(function () { const c = r.queue(this, a, b); r._queueHooks(this, a), a === 'fx' && c[0] !== 'inprogress' && r.dequeue(this, a); }); }, dequeue(a) { return this.each(function () { r.dequeue(this, a); }); }, clearQueue(a) { return this.queue(a || 'fx', []); }, promise(a, b) { let c; let d = 1; const e = r.Deferred(); const f = this; let g = this.length; const h = function () { --d || e.resolveWith(f, [f]); }; typeof a !== 'string' && (b = a, a = void 0), a = a || 'fx'; while (g--)c = V.get(f[g], `${a}queueHooks`), c && c.empty && (d++, c.empty.add(h)); return h(), e.promise(b); },
    }); const _ = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source; const aa = new RegExp(`^(?:([+-])=|)(${_})([a-z%]*)$`, 'i'); const ba = ['Top', 'Right', 'Bottom', 'Left']; const ca = function (a, b) { return a = b || a, a.style.display === 'none' || a.style.display === '' && r.contains(a.ownerDocument, a) && r.css(a, 'display') === 'none'; }; const da = function (a, b, c, d) { let e; let f; const g = {}; for (f in b)g[f] = a.style[f], a.style[f] = b[f]; e = c.apply(a, d || []); for (f in b)a.style[f] = g[f]; return e; }; function ea(a, b, c, d) { let e; let f = 1; let g = 20; const h = d ? function () { return d.cur(); } : function () { return r.css(a, b, ''); }; const i = h(); let j = c && c[3] || (r.cssNumber[b] ? '' : 'px'); let k = (r.cssNumber[b] || j !== 'px' && +i) && aa.exec(r.css(a, b)); if (k && k[3] !== j) { j = j || k[3], c = c || [], k = +i || 1; do f = f || '.5', k /= f, r.style(a, b, k + j); while (f !== (f = h() / i) && f !== 1 && --g); } return c && (k = +k || +i || 0, e = c[1] ? k + (c[1] + 1) * c[2] : +c[2], d && (d.unit = j, d.start = k, d.end = e)), e; } const fa = {}; function ga(a) { let b; const c = a.ownerDocument; const d = a.nodeName; let e = fa[d]; return e || (b = c.body.appendChild(c.createElement(d)), e = r.css(b, 'display'), b.parentNode.removeChild(b), e === 'none' && (e = 'block'), fa[d] = e, e); } function ha(a, b) { for (var c, d, e = [], f = 0, g = a.length; f < g; f++)d = a[f], d.style && (c = d.style.display, b ? (c === 'none' && (e[f] = V.get(d, 'display') || null, e[f] || (d.style.display = '')), d.style.display === '' && ca(d) && (e[f] = ga(d))) : c !== 'none' && (e[f] = 'none', V.set(d, 'display', c))); for (f = 0; f < g; f++)e[f] != null && (a[f].style.display = e[f]); return a; }r.fn.extend({ show() { return ha(this, !0); }, hide() { return ha(this); }, toggle(a) { return typeof a === 'boolean' ? a ? this.show() : this.hide() : this.each(function () { ca(this) ? r(this).show() : r(this).hide(); }); } }); const ia = /^(?:checkbox|radio)$/i; const ja = /<([a-z][^\/\0>\x20\t\r\n\f]+)/i; const ka = /^$|\/(?:java|ecma)script/i; const la = {
        option: [1, "<select multiple='multiple'>", '</select>'], thead: [1, '<table>', '</table>'], col: [2, '<table><colgroup>', '</colgroup></table>'], tr: [2, '<table><tbody>', '</tbody></table>'], td: [3, '<table><tbody><tr>', '</tr></tbody></table>'], _default: [0, '', ''],
    }; la.optgroup = la.option, la.tbody = la.tfoot = la.colgroup = la.caption = la.thead, la.th = la.td; function ma(a, b) { let c; return c = typeof a.getElementsByTagName !== 'undefined' ? a.getElementsByTagName(b || '*') : typeof a.querySelectorAll !== 'undefined' ? a.querySelectorAll(b || '*') : [], void 0 === b || b && r.nodeName(a, b) ? r.merge([a], c) : c; } function na(a, b) { for (let c = 0, d = a.length; c < d; c++)V.set(a[c], 'globalEval', !b || V.get(b[c], 'globalEval')); } const oa = /<|&#?\w+;/; function pa(a, b, c, d, e) { for (var f, g, h, i, j, k, l = b.createDocumentFragment(), m = [], n = 0, o = a.length; n < o; n++) if (f = a[n], f || f === 0) if (r.type(f) === 'object')r.merge(m, f.nodeType ? [f] : f); else if (oa.test(f)) { g = g || l.appendChild(b.createElement('div')), h = (ja.exec(f) || ['', ''])[1].toLowerCase(), i = la[h] || la._default, g.innerHTML = i[1] + r.htmlPrefilter(f) + i[2], k = i[0]; while (k--)g = g.lastChild; r.merge(m, g.childNodes), g = l.firstChild, g.textContent = ''; } else m.push(b.createTextNode(f)); l.textContent = '', n = 0; while (f = m[n++]) if (d && r.inArray(f, d) > -1)e && e.push(f); else if (j = r.contains(f.ownerDocument, f), g = ma(l.appendChild(f), 'script'), j && na(g), c) { k = 0; while (f = g[k++])ka.test(f.type || '') && c.push(f); } return l; }!(function () { const a = d.createDocumentFragment(); const b = a.appendChild(d.createElement('div')); const c = d.createElement('input'); c.setAttribute('type', 'radio'), c.setAttribute('checked', 'checked'), c.setAttribute('name', 't'), b.appendChild(c), o.checkClone = b.cloneNode(!0).cloneNode(!0).lastChild.checked, b.innerHTML = '<textarea>x</textarea>', o.noCloneChecked = !!b.cloneNode(!0).lastChild.defaultValue; }()); const qa = d.documentElement; const ra = /^key/; const sa = /^(?:mouse|pointer|contextmenu|drag|drop)|click/; const ta = /^([^.]*)(?:\.(.+)|)/; function ua() { return !0; } function va() { return !1; } function wa() { try { return d.activeElement; } catch (a) {} } function xa(a, b, c, d, e, f) { let g; let h; if (typeof b === 'object') { typeof c !== 'string' && (d = d || c, c = void 0); for (h in b)xa(a, h, c, d, b[h], f); return a; } if (d == null && e == null ? (e = c, d = c = void 0) : e == null && (typeof c === 'string' ? (e = d, d = void 0) : (e = d, d = c, c = void 0)), e === !1)e = va; else if (!e) return a; return f === 1 && (g = e, e = function (a) { return r().off(a), g.apply(this, arguments); }, e.guid = g.guid || (g.guid = r.guid++)), a.each(function () { r.event.add(this, b, e, d, c); }); }r.event = {
        global: {},
        add(a, b, c, d, e) {
            let f; let g; let h; let i; let j; let k; let l; let m; let n; let o; let p; const q = V.get(a); if (q) {
                c.handler && (f = c, c = f.handler, e = f.selector), e && r.find.matchesSelector(qa, e), c.guid || (c.guid = r.guid++), (i = q.events) || (i = q.events = {}), (g = q.handle) || (g = q.handle = function (b) { return typeof r !== 'undefined' && r.event.triggered !== b.type ? r.event.dispatch.apply(a, arguments) : void 0; }), b = (b || '').match(K) || [''], j = b.length; while (j--) {
        ...
        special: {
            load: { noBubble: !0 }, focus: { trigger() { if (this !== wa() && this.focus) return this.focus(), !1; }, delegateType: 'focusin' }, blur: { trigger() { if (this === wa() && this.blur) return this.blur(), !1; }, delegateType: 'focusout' }, click: { trigger() { if (this.type === 'checkbox' && this.click && r.nodeName(this, 'input')) return this.click(), !1; }, _default(a) { return r.nodeName(a.target, 'a'); } }, beforeunload: { postDispatch(a) { void 0 !== a.result && a.originalEvent && (a.originalEvent.returnValue = a.result); } },
        },
    }, r.removeEvent = function (a, b, c) { a.removeEventListener && a.removeEventListener(b, c); }, r.Event = function (a, b) { return this instanceof r.Event ? (a && a.type ? (this.originalEvent = a, this.type = a.type, this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && a.returnValue === !1 ? ua : va, this.target = a.target && a.target.nodeType === 3 ? a.target.parentNode : a.target, this.currentTarget = a.currentTarget, this.relatedTarget = a.relatedTarget) : this.type = a, b && r.extend(this, b), this.timeStamp = a && a.timeStamp || r.now(), void (this[r.expando] = !0)) : new r.Event(a, b); }, r.Event.prototype = {
        ...
        style(a, b, c, d) { if (a && a.nodeType !== 3 && a.nodeType !== 8 && a.style) { let e; let f; let g; const h = r.camelCase(b); const i = a.style; return b = r.cssProps[h] || (r.cssProps[h] = Ua(h) || h), g = r.cssHooks[b] || r.cssHooks[h], void 0 === c ? g && 'get' in g && void 0 !== (e = g.get(a, !1, d)) ? e : i[b] : (f = typeof c, f === 'string' && (e = aa.exec(c)) && e[1] && (c = ea(a, b, e), f = 'number'), c != null && c === c && (f === 'number' && (c += e && e[3] || (r.cssNumber[h] ? '' : 'px')), o.clearCloneStyle || c !== '' || b.indexOf('background') !== 0 || (i[b] = 'inherit'), g && 'set' in g && void 0 === (c = g.set(a, c, d)) || (i[b] = c)), void 0); } },
        css(a, b, c, d) { let e; let f; let g; const h = r.camelCase(b); return b = r.cssProps[h] || (r.cssProps[h] = Ua(h) || h), g = r.cssHooks[b] || r.cssHooks[h], g && 'get' in g && (e = g.get(a, !0, c)), void 0 === e && (e = Na(a, b, d)), e === 'normal' && b in Ra && (e = Ra[b]), c === '' || c ? (f = parseFloat(e), c === !0 || isFinite(f) ? f || 0 : e) : e; },
    }), r.each(['height', 'width'], (a, b) => { r.cssHooks[b] = { get(a, c, d) { if (c) return !Pa.test(r.css(a, 'display')) || a.getClientRects().length && a.getBoundingClientRect().width ? Xa(a, b, d) : da(a, Qa, () => Xa(a, b, d)); }, set(a, c, d) { let e; const f = d && Ma(a); const g = d && Wa(a, b, d, r.css(a, 'boxSizing', !1, f) === 'border-box', f); return g && (e = aa.exec(c)) && (e[3] || 'px') !== 'px' && (a.style[b] = c, c = r.css(a, b)), Va(a, c, g); } }; }), r.cssHooks.marginLeft = Oa(o.reliableMarginLeft, (a, b) => { if (b) return `${parseFloat(Na(a, 'marginLeft')) || a.getBoundingClientRect().left - da(a, { marginLeft: 0 }, () => a.getBoundingClientRect().left)}px`; }), r.each({ margin: '', padding: '', border: 'Width' }, (a, b) => { r.cssHooks[a + b] = { expand(c) { for (var d = 0, e = {}, f = typeof c === 'string' ? c.split(' ') : [c]; d < 4; d++)e[a + ba[d] + b] = f[d] || f[d - 2] || f[0]; return e; } }, Ka.test(a) || (r.cssHooks[a + b].set = Va); }), r.fn.extend({ css(a, b) { return S(this, (a, b, c) => { let d; let e; const f = {}; let g = 0; if (r.isArray(b)) { for (d = Ma(a), e = b.length; g < e; g++)f[b[g]] = r.css(a, b[g], !1, d); return f; } return void 0 !== c ? r.style(a, b, c) : r.css(a, b); }, a, b, arguments.length > 1); } }); function Ya(a, b, c, d, e) { return new Ya.prototype.init(a, b, c, d, e); }r.Tween = Ya, Ya.prototype = {
        constructor: Ya, init(a, b, c, d, e, f) { this.elem = a, this.prop = c, this.easing = e || r.easing._default, this.options = b, this.start = this.now = this.cur(), this.end = d, this.unit = f || (r.cssNumber[c] ? '' : 'px'); }, cur() { const a = Ya.propHooks[this.prop]; return a && a.get ? a.get(this) : Ya.propHooks._default.get(this); }, run(a) { let b; const c = Ya.propHooks[this.prop]; return this.options.duration ? this.pos = b = r.easing[this.easing](a, this.options.duration * a, 0, 1, this.options.duration) : this.pos = b = a, this.now = (this.end - this.start) * b + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), c && c.set ? c.set(this) : Ya.propHooks._default.set(this), this; },
    }, Ya.prototype.init.prototype = Ya.prototype, Ya.propHooks = { _default: { get(a) { let b; return a.elem.nodeType !== 1 || a.elem[a.prop] != null && a.elem.style[a.prop] == null ? a.elem[a.prop] : (b = r.css(a.elem, a.prop, ''), b && b !== 'auto' ? b : 0); }, set(a) { r.fx.step[a.prop] ? r.fx.step[a.prop](a) : a.elem.nodeType !== 1 || a.elem.style[r.cssProps[a.prop]] == null && !r.cssHooks[a.prop] ? a.elem[a.prop] = a.now : r.style(a.elem, a.prop, a.now + a.unit); } } }, Ya.propHooks.scrollTop = Ya.propHooks.scrollLeft = { set(a) { a.elem.nodeType && a.elem.parentNode && (a.elem[a.prop] = a.now); } }, r.easing = { linear(a) { return a; }, swing(a) { return 0.5 - Math.cos(a * Math.PI) / 2; }, _default: 'swing' }, r.fx = Ya.prototype.init, r.fx.step = {}; let Za; let $a; const _a = /^(?:toggle|show|hide)$/; const ab = /queueHooks$/; function bb() { $a && (a.requestAnimationFrame(bb), r.fx.tick()); } function cb() { return a.setTimeout(() => { Za = void 0; }), Za = r.now(); } function db(a, b) { let c; let d = 0; const e = { height: a }; for (b = b ? 1 : 0; d < 4; d += 2 - b)c = ba[d], e[`margin${c}`] = e[`padding${c}`] = a; return b && (e.opacity = e.width = a), e; } function eb(a, b, c) { for (var d, e = (hb.tweeners[b] || []).concat(hb.tweeners['*']), f = 0, g = e.length; f < g; f++) if (d = e[f].call(c, b, a)) return d; } function fb(a, b, c) { let d; let e; let f; let g; let h; let i; let j; let k; const l = 'width' in b || 'height' in b; const m = this; const n = {}; const o = a.style; let p = a.nodeType && ca(a); let q = V.get(a, 'fxshow'); c.queue || (g = r._queueHooks(a, 'fx'), g.unqueued == null && (g.unqueued = 0, h = g.empty.fire, g.empty.fire = function () { g.unqueued || h(); }), g.unqueued++, m.always(() => { m.always(() => { g.unqueued--, r.queue(a, 'fx').length || g.empty.fire(); }); })); for (d in b) if (e = b[d], _a.test(e)) { if (delete b[d], f = f || e === 'toggle', e === (p ? 'hide' : 'show')) { if (e !== 'show' || !q || void 0 === q[d]) continue; p = !0; }n[d] = q && q[d] || r.style(a, d); } if (i = !r.isEmptyObject(b), i || !r.isEmptyObject(n)) { l && a.nodeType === 1 && (c.overflow = [o.overflow, o.overflowX, o.overflowY], j = q && q.display, j == null && (j = V.get(a, 'display')), k = r.css(a, 'display'), k === 'none' && (j ? k = j : (ha([a], !0), j = a.style.display || j, k = r.css(a, 'display'), ha([a]))), (k === 'inline' || k === 'inline-block' && j != null) && r.css(a, 'float') === 'none' && (i || (m.done(() => { o.display = j; }), j == null && (k = o.display, j = k === 'none' ? '' : k)), o.display = 'inline-block')), c.overflow && (o.overflow = 'hidden', m.always(() => { o.overflow = c.overflow[0], o.overflowX = c.overflow[1], o.overflowY = c.overflow[2]; })), i = !1; for (d in n)i || (q ? 'hidden' in q && (p = q.hidden) : q = V.access(a, 'fxshow', { display: j }), f && (q.hidden = !p), p && ha([a], !0), m.done(() => { p || ha([a]), V.remove(a, 'fxshow'); for (d in n)r.style(a, d, n[d]); })), i = eb(p ? q[d] : 0, d, m), d in q || (q[d] = i.start, p && (i.end = i.start, i.start = 0)); } } function gb(a, b) { let c; let d; let e; let f; let g; for (c in a) if (d = r.camelCase(c), e = b[d], f = a[c], r.isArray(f) && (e = f[1], f = a[c] = f[0]), c !== d && (a[d] = f, delete a[c]), g = r.cssHooks[d], g && 'expand' in g) { f = g.expand(f), delete a[d]; for (c in f)c in a || (a[c] = f[c], b[c] = e); } else b[d] = e; } function hb(a, b, c) {
        let d; let e; let f = 0; const g = hb.prefilters.length; const h = r.Deferred().always(() => { delete i.elem; }); var i = function () { if (e) return !1; for (var b = Za || cb(), c = Math.max(0, j.startTime + j.duration - b), d = c / j.duration || 0, f = 1 - d, g = 0, i = j.tweens.length; g < i; g++)j.tweens[g].run(f); return h.notifyWith(a, [j, f, c]), f < 1 && i ? c : (h.resolveWith(a, [j]), !1); }; var j = h.promise({
        ...
        ajaxSettings: {
            ...
            accepts: {
                '*': Hb, text: 'text/plain', html: 'text/html', xml: 'application/xml, text/xml', json: 'application/json, text/javascript',
            },
        ...
        ajaxSetup(a, b) { return b ? Lb(Lb(a, r.ajaxSettings), b) : Lb(r.ajaxSettings, a); },
        ajaxPrefilter: Jb(Fb),
        ajaxTransport: Jb(Gb),
        ajax(b, c) {
    ...
    }), r.parseJSON = JSON.parse, typeof define === 'function' && define.amd && define('jquery', [], () => r); const Tb = a.jQuery; const Ub = a.$; return r.noConflict = function (b) { return a.$ === r && (a.$ = Ub), b && a.jQuery === r && (a.jQuery = Tb), r; }, b || (a.jQuery = a.$ = r), r;
}));
