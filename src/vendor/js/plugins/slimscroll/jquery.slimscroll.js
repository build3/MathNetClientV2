...
(function ($) {
    $.fn.extend({
        slimScroll(options) {
            ...
            this.each(function () {
                let isOverPanel; let isOverBar; let isDragg; let queueHide; let touchDif;
                let barHeight; let percentScroll; let lastScroll;
                const divS = '<div></div>';
                ...
                function getBarHeight() {
                    ...
                    const display = barHeight == me.outerHeight() ? 'none' : 'block';
                    bar.css({ display });
                }
                ...
                function showBar() {
                    ...
                    if (percentScroll == ~~percentScroll) {
                        ...
                        if (lastScroll != percentScroll) {
                            const msg = (~~percentScroll == 0) ? 'top' : 'bottom';
